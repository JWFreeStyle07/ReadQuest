...
// export default function QuestionMaker({ navigation, route }: any) {
//   const { numberOfQuestions, bookId, bookTitle, bookPassage } = route.params;
...
//           {
//             text: 'OK',
//             onPress: () => router.push('/teacher/quizManagement'),
//           },
//         ]
//       );
//     } catch (error) {
...
//             text: 'OK',
//             onPress: () => {
//               // Go back twice: once from QuestionMaker, once from QuizManagement
//               router.back();
