...
const COUNTING_HOURS_TEXT = "When men decided to divide the day into twenty four hours, they used numbers one through twelve two times. As a result, there was one oclock during the day and another one oclock after midnight.";
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.controlsContainer}>
        ...
        onPress={() => router.push({
            ...
            params: { title: 'Counting The Hours' }
        })}
        >
