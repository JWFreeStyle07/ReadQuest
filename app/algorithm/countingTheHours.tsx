...
const CountingTheHoursApp = () => {
  ...
  const REFERENCE_TEXT = COUNTING_HOURS_TEXT;
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.textContainer}>
        <Text style={styles.storyTitle}>Counting The Hours</Text>
