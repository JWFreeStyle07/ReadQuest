...
const StudentAnalytics = () => {
  ...
  const getQuizResults = () => {
    ...
    return Object.entries(studentData.storyScores)
      .filter(([_, scores]) => scores.quizCompletedAt) // Only include books with quiz data
  ...
  const oralSessions = getOralReadingSessions();
  ...
  return (
    <View style={styles.container}>
      ...
      >
        ...
        {/* Quiz Results Table */}
        <View style={[styles.tableContainer, styles.quizTableContainer]}>
