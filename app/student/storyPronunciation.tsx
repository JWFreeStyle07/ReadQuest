...
// const StoryPronunciation = () => {
//   const router = useRouter();
//   const params = useLocalSearchParams();
  
//   // Extract params from route
//   const bookId = params.bookId as string;
//   const storyTitle = params.title as string || 'Story';
//   const storyPassage = params.passage as string || '';
//   const storyPoints = parseInt(params.points as string) || 100;
//   const storyImageURL = params.imageURL as string;
...
//   // Use dynamic passage from params
//   const REFERENCE_TEXT = storyPassage;
...
//     if (!REFERENCE_TEXT || REFERENCE_TEXT.trim() === '') {
//       Alert.alert('Error', 'No story text available for analysis');
//       return;
//     }
...
// export default StoryPronunciation;
...
//   // Get story data from params or use default
//   const storyTitle = params.title as string || "Story";
//   const storyPassage = params.passage as string || "";
//   const storyPoints = parseInt(params.points as string) || 0;
//   const bookId = params.bookId as string || "";
...
//     if (!REFERENCE_TEXT || REFERENCE_TEXT.trim() === '') {
//       Alert.alert('Error', 'No story passage available for analysis');
//       return;
//     }
...
//         Granularity: 'Word',
//         Dimension: 'Comprehensive',
//         EnableMiscue: false, // Less strict on word substitutions
//         ScenarioId: 'Topic.Conversation.Children' // Optimized for children/learners
//       };
...
//   // Process results and extract word timestamps with score adjustment
//   const processPronunciationResult = (result: any) => {
//     if (result.NBest && result.NBest.length > 0) {
//       const bestResult = result.NBest[0];

//       // Apply a slight boost to scores (5-10 point adjustment for learners)
//       const boostFactor = 1.08; // 8% boost
//       const minBoost = 5; // Minimum 5 points added
...
//       const processedResult = {
//         accuracyScore: adjustScore(bestResult.AccuracyScore || 0),
//         fluencyScore: adjustScore(bestResult.FluencyScore || 0),
//         completenessScore: adjustScore(bestResult.CompletenessScore || 0),
//         pronunciationScore: adjustScore(bestResult.PronScore || 0),
//         recognizedText: bestResult.Display || '',
//         words:
//           bestResult.Words?.map((word: any) => ({
//             word: word.Word,
//             accuracyScore: adjustScore(word.AccuracyScore || 0),
//             errorType: word.ErrorType || 'None',
//             offset: word.Offset || 0,
//             duration: word.Duration || 0,
//             phonemes:
//               word.Phonemes?.map((phoneme: any) => ({
//                 phoneme: phoneme.Phoneme,
//                 accuracyScore: adjustScore(phoneme.AccuracyScore || 0),
//               })) || [],
//           })) || [],
//       };
...
//   const getScoreColor = (score: any) => {
//     if (score >= 50) return '#4CAF50'; // Lowered from 55
//     if (score >= 25) return '#FF9800'; // Lowered from 30
//     if (score >= 0) return '#F44336';
//   };
...
//   // UPDATED: Optimized recording options
...
//       // FIXED: Corrected pronunciation configuration
//       const pronunciationConfig = {
//         ReferenceText: REFERENCE_TEXT,
//         GradingSystem: 'HundredMark',
...
//       console.log('Reference text length:', REFERENCE_TEXT.length);
...
//       Alert.alert(
//         'Error', 
//         'Failed to analyze pronunciation. Please try recording again with clear speech.'
//       );
//     } finally {
//       setIsAnalyzing(false);
//     }
