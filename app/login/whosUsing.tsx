...
const SecondScreen = () => {
  ...
  const handleUserTypeSelection = async (userType: 'student' | 'teacher') => {
    try {
      ...
      // Store user type in AsyncStorage temporarily
      // This will be used later when the user completes authentication
      ...
      Alert.alert("Error", "Failed to store user type. Please try again.");
    } finally {
      setLoading(false);
    }
  };
