...
// // Story data with titles, points, and images - Updated with correct routes
// const STORIES = [
//   { 
//     title: "Telling Time", 
//     points: 100, 
//     image: require("../../assets/images/books/tellingTime.png"),
//     route: "offline/universalStory" as const,
//     storyKey: "Telling Time"
//   },
//   { 
//     title: "Counting The Hours", 
//     points: 80, 
...
//     image: require("../../assets/images/books/noseBleeds.png"),
//     route: "../../offline/universalStory" as const,
//     storyKey: "Nose Bleeds"
//   },
// ];

// // Suggested books data - matched with STORIES and correct routes
// const SUGGESTED_BOOKS = [
//   { 
//     id: 1, 
//     image: require("../../assets/images/books/tellingTime.png"), 
...
//   // Navigate to story with title parameter
//   const navigateToStory = (storyTitle: string, route: string) => {
//     router.push({
//       pathname: route,
//       params: { title: encodeURIComponent(storyTitle) }
//     } as any);
//   };
...
//             <TouchableOpacity
//               style={styles.readButton}
//               onPress={() => navigateToStory(todayStory.storyKey, todayStory.route)}
//             >
//               <Text style={styles.readButtonText}>Read</Text>
//             </TouchableOpacity>
...
//               key={book.id}
//               style={[styles.bookContainer, getBookStyle(index)]}
//               onPress={() => navigateToStory(book.storyKey, book.route)}
//             >
//               <Image
//                 source={book.image}
//                 style={styles.bookImage}
...
// Story data with titles, points, and images - Updated with correct routes
// Since universalStory.tsx is in the same folder, use "./universalStory"
const STORIES = [
  { 
    title: "Telling Time", 
    points: 100, 
    image: require("../../assets/images/books/tellingTime.png"),
    route: "./universalStory" as const,
    storyKey: "Telling Time"
  },
  { 
    title: "Counting The Hours", 
